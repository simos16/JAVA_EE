...
public class ProductDAO {
	...
	static {
		data.add(new Product(1, "scarpe", 132.87f));
		data.add(new Product(2, "tshirt", 45.87f));
		data.add(new Product(3, "golf", 765f));
		data.add(new Product(4, "camice", 98.45f));
	}
